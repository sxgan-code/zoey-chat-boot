...
public class DateUtil extends DateUtils {
    ...
    public static boolean isBetween(String dateStr, String beginStr, String endStr, String pattern) {
        Date date = DateUtil.parseStrToDate(dateStr, pattern);
        Date beginDate = DateUtil.parseStrToDate(beginStr, pattern);
        Date endDate = DateUtil.parseStrToDate(endStr, pattern);
